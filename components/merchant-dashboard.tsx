  ...
  const statsCards = [
    {
      ...
      value: stats ? `$${stats.totalTipsToday.toFixed(2)}` : "$0.00",
      change: stats ? `${stats.percentChangeToday > 0 ? '+' : ''}${stats.percentChangeToday.toFixed(1)}%` : "+0%",
      icon: DollarSign,
      color: "text-green-400",
    },
    {
      title: "This Week",
      value: stats ? `$${stats.totalTipsThisWeek.toFixed(2)}` : "$0.00",
      change: stats ? `${stats.percentChangeWeek > 0 ? '+' : ''}${stats.percentChangeWeek.toFixed(1)}%` : "+0%",
      icon: TrendingUp,
      color: "text-blue-400",
    },
    {
      title: "All Time Earnings",
      value: stats ? `$${stats.totalTipsAllTime.toFixed(2)}` : "$0.00",
      change: null,
      icon: CreditCard,
    ...
    },
    {
      ...
      value: stats ? stats.tipCountTotal.toString() : "0",
      change: null,
      icon: Users,
